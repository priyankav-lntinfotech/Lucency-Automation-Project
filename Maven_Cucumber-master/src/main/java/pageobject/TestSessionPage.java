...
public class TestSessionPage extends BaseActions{
	...
	public By Model_Msg = By.xpath("//div[@id='modal-test-session-success-modal-content']/div[1]");
	...
	public By Numbers = By.xpath("//div[@id='choices--test_session_add_number-item-choice-1']");
	...
	By SelectCampaign = By.xpath("//div[@class='p-choice-item p-choice-item-selectable'][1]");
	//By SelectCampaign = By.xpath("(//DIV[@class='p-choice-inner'])[1]");
	
	
	By selectCampaignValue = By.xpath("//div[@id='choices--test_session_add_campaign-item-choice-4']");
	...
	By BtnDeleteTestSession = By.xpath("//SPAN[@class='f-title'][text()='Delete'][text()='Delete'][1]");
